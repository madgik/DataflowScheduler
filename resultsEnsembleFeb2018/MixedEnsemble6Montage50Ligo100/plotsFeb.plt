...
system "mkdir plotsBiobj"

set output 'plotsBiobj/skyline.eps'
...
"dagMergeCP/Biobj/ensemble.dat" using ($1):($2/60000) title 'dagMergeCP' with points pt 2 lc rgb 'blue',\
"dagMergeBR/Biobj/ensemble.dat" using ($1):($2/60000) title 'dagMergeBR' with points pt 3 lc rgb 'green'
set output 'others.eps'

set output 'plotsBiobj/unfairnessToMoney.eps'
set xlabel 'Total Money ($)'
...
"dagMergeCP/Biobj/ensemble.dat" using ($1):($7) title 'dagMergeCP' with points pt 2 lc rgb 'blue',\
"dagMergeBR/Biobj/ensemble.dat" using ($1):($7) title 'dagMergeBR' with points pt 3 lc rgb 'green'
set output 'others.eps'
...
set xlabel 'Total Money ($)'
set ylabel 'Execution Time (min)'
plot "commonEntry/Multiobj/ensemble.dat" using ($1):($2/60000) title 'HHDS: minUtilization (commonEntry)' with points pt 8 lc rgb 'black',\
...
set xlabel 'Total Money ($)'
set ylabel 'Unfairness'
plot "commonEntry/Multiobj/ensemble.dat" using ($1):($7) title 'HHDS: minUtilization (commonEntry)' with points pt 8 lc rgb 'black',\
