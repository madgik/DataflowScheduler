...
"weightByDag/ensemble4.txt" using ($1):($5) title 'weightByDag' with points pt 1 lc rgb 'grey'
...
"weightByDag/ensemble4.txt" using ($3):($4) title 'weightByDag' with points pt 1 lc rgb 'grey'
set output 'plots/others.eps'
...
"weightByDag/ensemble4.txt" using ($1):($2/60000) title 'weightByDag' with points pt 1 lc rgb 'grey'
set output 'plots/others.eps'
...
"weightByDag/ensemble4.txt" using ($1):($4) title 'weightByDag' with points pt 1 lc rgb 'grey'
set output 'plots/others.eps'
...
"weightByDag/ensemble4.txt" using ($1):($7) title 'weightByDag' with points pt 1 lc rgb 'grey'
set output 'plots/others.eps'
...
"weightByDag/ensemble4.txt" using ($7):($2/60000) title 'weightByDag' with points pt 1 lc rgb 'grey'
set output 'plots/others.eps'
...
"weightByDag/ensemble4.txt" using ($1):($6) title 'weightByDag' with points pt 1 lc rgb 'grey'
set output 'plots/others.eps'
