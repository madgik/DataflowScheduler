...
"dagMerge/Multiobj/ensemble.dat" using ($1):($2/60000) title 'HHDS-F: multiObj dagMerge' with points pt 3 lc rgb 'blue',\
...
"dagMerge/Multiobj/ensemble.dat" using ($1):($7) title 'HHDS-F: multiObj dagMerge' with points pt 3 lc rgb 'blue',\
...
set xlabel 'Total Money ($)'
set ylabel 'Stretch'
plot "commonEntry/Biobj/ensemble.dat" using ($1):($4) title 'HHDS: biObj commonEntry' with points pt 8 lc rgb 'black',\
"dagMerge/Multiobj/ensemble.dat" using ($1):($4) title 'HHDS-F: multiObj dagMerge' with points pt 3 lc rgb 'blue',\
...
"dagMerge/Multiobj/ensemble.dat" using ($1):($6) title 'HHDS-F: multiObj dagMerge' with points pt 3 lc rgb 'blue',\
...
set ylabel 'Ex. Time (min)'
splot "commonEntry/Biobj/ensemble.dat" using ($1):($2/60000):($4) title 'HHDS: biObj commonEntry' with points pt 8 lc rgb 'black',\
"dagMerge/Multiobj/ensemble.dat" using ($1):($2/60000):($4) title 'HHDS-F: multiObj dagMerge' with points pt 3 lc rgb 'blue',\
"Moheft/ensemble.dat" using ($1):($2/60000):($4) title 'Moheft: biObj commonEntry' with points pt 4 lc rgb 'grey',\
"commonEntry/Multiobj/ensemble.dat" using ($1):($2/60000):($4) title 'multiObj commonEntry' with points pt 8 lc rgb 'green',\
"dagMerge/Biobj/ensemble.dat" using ($1):($2/60000):($4) title 'biObj dagMerge' with points pt 3 lc rgb 'purple'
set output 'others.eps'
...
"commonEntry/Multiobj/ensemble.dat" using ($1):($2/60000):($6) title 'multiObj commonEntry' with points pt 8 lc rgb 'green',\
"dagMerge/Biobj/ensemble.dat" using ($1):($2/60000):($6) title 'biObj dagMerge' with points pt 3 lc rgb 'purple'
set output 'others.eps'
...
"commonEntry/Multiobj/ensemble.dat" using ($1):($2/60000):($7) title 'multiObj commonEntry' with points pt 8 lc rgb 'green',\
"dagMerge/Biobj/ensemble.dat" using ($1):($2/60000):($7) title 'biObj dagMerge' with points pt 3 lc rgb 'purple'
set output 'others.eps'
unset hidden3d
