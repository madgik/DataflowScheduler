...
import main.java.Graph.Data;
import main.java.Graph.Edge;
import main.java.Graph.ResourcesRequirements;
...
public class JsonOptiqueParser {
    ...
    public DAG parse(String filepath){
        ...
        for(Operator opjp : jp.getOperators()){
           ...
           main.java.Graph.Operator op = new main.java.Graph.Operator(opjp.getOperatorName(),re);
