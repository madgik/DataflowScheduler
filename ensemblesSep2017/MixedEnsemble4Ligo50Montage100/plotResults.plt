...
"PUT/ensemble4.txt" using ($1):($5) title 'PUT' with points pt 1 lc rgb 'grey'
...
"PUT/ensemble4.txt" using ($3):($4) title 'PUT' with points pt 1 lc rgb 'grey'
set output 'plots/others.eps'
...
"PUT/ensemble4.txt" using ($1):($2/60000) title 'PUT' with points pt 1 lc rgb 'grey'
set output 'plots/others.eps'
...
"PUT/ensemble4.txt" using ($1):($4) title 'PUT' with points pt 1 lc rgb 'grey'
set output 'plots/others.eps'
...
"PUT/ensemble4.txt" using ($1):($7) title 'PUT' with points pt 1 lc rgb 'grey'
set output 'plots/others.eps'
...
"PUT/ensemble4.txt" using ($7):($2/60000) title 'PUT' with points pt 1 lc rgb 'grey'
set output 'plots/others.eps'
...
"PUT/ensemble4.txt" using ($1):($6) title 'PUT' with points pt 1 lc rgb 'grey'
set output 'plots/others.eps'
