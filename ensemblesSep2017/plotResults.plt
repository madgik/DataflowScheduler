...
"slackPathPerc/ensemble4.txt" using ($1):($5) title 'slackPathPerc' with points pt 1 lc rgb 'grey'
...
"slackPathPerc/ensemble4.txt" using ($3):($4) title 'slackPathPerc' with points pt 1 lc rgb 'grey'
set output 'plots/others.eps'
...
"slackPathPerc/ensemble4.txt" using ($1):($2/60000) title 'slackPathPerc' with points pt 1 lc rgb 'grey'
set output 'plots/others.eps'
...
"slackPathPerc/ensemble4.txt" using ($1):($4) title 'slackPathPerc' with points pt 1 lc rgb 'grey'
set output 'plots/others.eps'
...
"slackPathPerc/ensemble4.txt" using ($1):($7) title 'slackPathPerc' with points pt 1 lc rgb 'grey'
set output 'plots/others.eps'
...
"slackPathPerc/ensemble4.txt" using ($7):($2/60000) title 'slackPathPerc' with points pt 1 lc rgb 'grey'
set output 'plots/others.eps'
...
"slackPathPerc/ensemble4.txt" using ($1):($6) title 'slackPathPerc' with points pt 1 lc rgb 'grey'
set output 'plots/others.eps'
