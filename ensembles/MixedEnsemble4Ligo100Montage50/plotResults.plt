...
"heftRank/ensemble4.txt" using ($1):($5) title 'heftRank' with points pt 10 lc rgb 'black'
...
"heftRank/ensemble4.txt" using ($3):($4) title 'heftRank' with points pt 10 lc rgb 'black'
set output 'plots/others.eps'
...
"heftRank/ensemble4.txt" using ($1):($2/60000) title 'heftRank' with points pt 10 lc rgb 'black'
set output 'plots/others.eps'
...
"heftRank/ensemble4.txt" using ($1):($4) title 'heftRank' with points pt 10 lc rgb 'black'
...
"heftRank/ensemble4.txt" using ($1):($7) title 'heftRank' with points pt 10 lc rgb 'black'
set output 'plots/others.eps'
...
"heftRank/ensemble4.txt" using ($7):($2/60000) title 'heftRank' with points pt 10 lc rgb 'black'
set output 'plots/others.eps'
...
"heftRank/ensemble4.txt" using ($1):($6) title 'heftRank' with points pt 10 lc rgb 'black'
set output 'plots/others.eps'
